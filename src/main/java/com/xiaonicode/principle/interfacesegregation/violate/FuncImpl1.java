 ...
 * @description: Interface1Impl 实现了 IFunc 的 func1, func2, func3, func4, func5 方法
 */
public class FuncImpl1 implements IFunc {
    ...
    @Override
    public void func4() {
        System.out.println("Interface1Impl 中实现了 func4 方法");
    }

    @Override
    public void func5() {
        System.out.println("Interface1Impl 中实现了 func5 方法");
    }
